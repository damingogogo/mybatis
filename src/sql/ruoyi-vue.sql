...
(
    id    int auto_increment comment 'ID'
        primary key,
    nj_id varchar(255) not null,
    jz_id varchar(255) null
);
...
(
    id            int auto_increment comment 'ID'
        primary key,
    name          varchar(40)  null comment '学校名称',
    code          varchar(10)  null comment '学校代码',
    sort          varchar(10)  null comment '排序',
    address       varchar(100) null comment '学校地址',
    images        varchar(255) null comment '学校图片',
    nj_number     varchar(5)   null comment '年级总人数',
    bj_number     varchar(5)   null comment '班级总人数',
    school_number varchar(5)   null comment '学校总人数'
);
...
(
    id        int auto_increment comment 'ID'
        primary key,
    name      varchar(10) null comment '年级名称',
    bj_number varchar(10) null comment '班级总数',
    nj_number varchar(10) null comment '年级总人数',
    school_id int         null comment '学校id',
    constraint fk_nj_school
...
(
    id        int auto_increment comment 'ID'
        primary key,
    name      varchar(20)  null comment '班级名称',
    bj_number varchar(5)   null comment '班级总人数',
    images    varchar(255) null comment '班级图片',
    nj_id     int          null comment '年级id',
    constraint fk_bj_nj
        foreign key (nj_id) references nj (id)
            on delete set null
);
